...
O pacote *Gifi* descende do pacote *Homals* como sendo uma versão melhorada, mais fácil de manipular por parte do utilizador e mais flexível devido a uma subtil diferença na formulação da função de perda e ao facto desta utilizar bases *B-spline*.
...
***Palavras-chave:*** Variáveis categóricas, Análise de componentes principais, Análise de componentes principais categórica, ACPCAT, R, *shiny*
