...
windows()
plot(a, plot.type = "transplot", plot.dim = c(1,2), var.subset = c("Fruto_citrino", "Fruto_arvore", "Fruto_tropical", "Vegetal_fresco", "Vegetal_seco", "Melado", "Calor", "Adstrigencia", "Equilibrio", "Persistencia", "Qualidade_cor"), xlab = "Categorias", ylab = "Quantificações")
#Gráfico para as restantes variáveis que será disponibilizado em Apêndice
windows()
plot(a, plot.type = "transplot", plot.dim = c(1,2), var.subset = c("Fruto_seco", "Floral", "Mineral", "Gas_carbonico", "Docura", "Acidez", "Amargor", "Estrutura", "Limpidez", "Cor", "Intensidade", "Evolucao"), xlab = "Categorias", ylab = "Quantificações")
